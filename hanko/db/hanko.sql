DROP DATABASE IF EXISTS `hanko`;

CREATE DATABASE  `hanko` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `sys_menu` VALUES (9999, '系统官网', NULL, 'https://hanko4cloud.com/#/', -1, 'icon-guanwangfangwen', NULL, 9, '0', '0', '2019-01-17 17:05:19', '2020-03-11 23:52:57', '0');
COMMIT;
...
INSERT INTO `sys_oauth_client_details` VALUES ('hanko', NULL, 'hanko', 'server', 'password,refresh_token,authorization_code,client_credentials', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login', NULL, NULL, NULL, NULL, 'true');
...
/*
 * Copyright (c) 2020 hanko4cloud Authors. All Rights Reserved.
 *
